...
The home page includes a catalog summary card showing the total number of games and the average rating, with a direct link to the catalog browser. The catalog page supports category filtering so visitors can jump from a top-level summary into a narrower list of games.
